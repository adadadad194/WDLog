...
class TInstWithLogits:
    def __init__(self, batch_size, slen, tag_size, wide_size):
        self.src_ids = []
        ...
        self.wide_input = Variable(torch.Tensor(batch_size, wide_size).zero_(), requires_grad=False)
    ...
    def to_cuda(self, device):
        ...
        self.wide_input = self.wide_input.cuda(device)
